...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $msg = "";
    $sql = "insert into staff values('$staffid','$staffname','$mail','$deptid')";
                    ...
                    <table cellpadding="10">
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="staffid" placeholder="Staff Id" name="staffid" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="staffname" placeholder="Staff Name" name="staffname" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="email" class="form-control" id="mail" placeholder="Gmail" name="mail" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
