                    ...
                    <table cellpadding="10">
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="courseid" placeholder="Course Id" name="courseid" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="coursename" placeholder="Course Name" name="coursename" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
