...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "insert into subject values('$subjectid','$subjectname','$deptid')";
                    ...
                    <table cellpadding="10">
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="subjectid" placeholder="Subject Id" name="subjectid" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="subjectname" placeholder="Subject Name" name="subjectname" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <div class="form-group">
