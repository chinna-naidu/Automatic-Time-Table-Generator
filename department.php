...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $msg = "";
    $sql = "insert into department values('$deptid','$deptname','$cname')";
                    ...
                    <table cellpadding="10">
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="deptid" placeholder="Department Id" name="deptid" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group">
                                ...
                                <td>
                                    <input type="text" class="form-control" id="deptname" placeholder="Department Name" name="deptname" required="" autofocus>
                                </td>
                            </div>
                        </tr>
                        <tr>
